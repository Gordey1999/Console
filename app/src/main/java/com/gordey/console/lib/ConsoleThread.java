...
public class ConsoleThread extends Thread {
    ...
    public ConsoleThread(SurfaceHolder surfaceHolder, ConsoleView view) {
        super();
    ...
    public void run() {
        ...
        long millisLastUpdate = System.currentTimeMillis();
        int updateDiff;
        ...
        while (running) {
            ...
            updateDiff = (int)(System.currentTimeMillis() - millisLastUpdate);
            needRedraw = this.view.update(updateDiff);
            millisLastUpdate = System.currentTimeMillis();
    ...
    private void storeStats() {
        ...
        if (statusIntervalTimer >= lastStatusStore + STAT_INTERVAL) {
            ...
            view.setAvgFps("FPS: " + (int)averageFps);
        }
    }
